...
TwoStacks* createTwoStacks(int size) {
    ...
    twoStacks->data = (int*) malloc(size * sizeof(int));
    twoStacks->top1 = -1;
    twoStacks->top2 = size;
    twoStacks->size = size;
    return twoStacks;
...
int isEmptyStack2(TwoStacks* twoStacks) {
    return twoStacks->top2 == twoStacks->size;
}
...
void displayStacks(TwoStacks* twoStacks) {
    ...
    printf("Stack 2: ");
    for (i = twoStacks->top2; i < twoStacks->size; i++) {
        printf("%d ", twoStacks->data[i]);
    }
    printf("\n");
}
...
int main() {
    ...
    TwoStacks* twoStacks = createTwoStacks(size);
